...
You can use this component in Vue, Preact, markdown (etc, etc) with ease. Here are a few tips:
  ...
  4. The component may use a (default) value from the modular scale used at https://every-layout.dev. It will look something like `var(--s[number])`. You should either steal Every Layout's modular scale, make your own  with the same naming conventions, or use a different value within the JavaScript file.
